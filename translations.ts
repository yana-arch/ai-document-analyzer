const translations = {
  en: {
    ...
    overview: {
      ...
      topicsCount: "Topics Identified",
      shortcuts: "Keyboard Shortcuts",
      overviewShortcut: "Ctrl+1",
      qaShortcut: "Ctrl+2",
      practiceShortcut: "Ctrl+3",
      fullTextShortcut: "Ctrl+F",
    },
    breadcrumb: {
      home: "Home",
    },
    suggestions: {
      ...
      readSummaryDesc: "Get an overview of the document",
    },
    cv: {
    ...
    interview: {
        ...
        generatingResults: "Generating Interview Results...",
        generatingResultsDesc: "Please wait while we analyze your performance and generate detailed feedback.",
        completeTitle: "Interview Complete!",
        completeSubtitle: "Here's your detailed performance analysis for the {targetPosition} position",
        ...
        practiceAnother: "Practice Another Interview",
        viewHistory: "View Interview History",
        completedInfo: "Completed on {date} • {interviewType} Interview",
    },
    history: {
    ...
    settings: {
      ...
      enablePerformanceMonitoringDesc: "Show real-time performance metrics and monitoring dashboard",
      enableVirtualScrolling: "Enable Virtual Scrolling",
      enableVirtualScrollingDesc: "Optimize performance for large document lists and history",
      enableCaching: "Enable AI Response Caching",
      enableCachingDesc: "Cache AI responses to improve performance and reduce API usage",
      cancel: "Cancel",
      ...
      detailsText4: "Performance monitoring helps track system performance and optimize user experience.",
      detailsText5: "Virtual scrolling improves performance when working with large lists.",
      detailsText6: "AI caching reduces response times and API usage.",
      later: "Decide Later",
    ...
    common: {
      ...
      performance: {
        ...
        aiServicePerformance: "AI Service Performance",
      ...
      // Keyboard shortcuts
      shortcuts: "Keyboard Shortcuts",
      shortcutInfo: "Press Ctrl/Cmd + key for quick navigation",
      overviewShortcut: "Overview",
      qaShortcut: "Q&A",
      practiceShortcut: "Practice",
      searchShortcut: "Search",
      performanceShortcut: "Performance Monitor",
    }
  },
  vi: {
    header: {
    ...
    overview: {
      ...
      topicsCount: "Chủ đề Được Xác định",
      shortcuts: "Phím tắt",
      overviewShortcut: "Ctrl+1",
      qaShortcut: "Ctrl+2",
      practiceShortcut: "Ctrl+3",
    ...
    suggestions: {
      readSummary: "Đọc Tóm tắt",
      readSummaryDesc: "Nhận cái nhìn tổng quan về tài liệu",
    },
    cv: {
    ...
    uploader: {
      ...
      urlInput: "Nhập URL",
      urlPlaceholder: "https://example.com/bai-viet",
    ...
    interview: {
        ...
        generatingResults: "Đang tạo kết quả phỏng vấn...",
        generatingResultsDesc: "Vui lòng đợi trong khi chúng tôi phân tích hiệu suất của bạn và tạo phản hồi chi tiết.",
        completeTitle: "Hoàn thành Phỏng vấn!",
        completeSubtitle: "Đây là phân tích hiệu suất chi tiết của bạn cho vị trí {targetPosition}",
        overallScore: "Điểm Tổng thể",
        positionMatch: "Khớp Vị trí",
        ...
        questionBreakdown: "Phân tích Câu hỏi từng câu",
        yourAnswer: "Câu trả lời của bạn:",
        improvements: "Cải thiện",
        practiceAnother: "Luyện tập Phỏng vấn khác",
        viewHistory: "Xem Lịch sử Phỏng vấn",
        completedInfo: "Hoàn thành vào {date} • Phỏng vấn {interviewType}",
    },
    history: {
      ...
      syncButton: "Đồng bộ với Cơ sở dữ liệu",
