const translations = {
  en: {
    ...
    uploader: {
      ...
      welcomeTitle: "Document Intelligence Analyzer",
      welcomeDesc: "Upload any document to get instant AI-powered analysis, key insights, topics extraction, entity recognition, and much more.",
      description: "Drag & drop a document or click to select",
  ...
  vi: {
    ...
    uploader: {
      ...
      welcomeTitle: "Trình phân tích tài liệu thông minh",
      welcomeDesc: "Tải lên bất kỳ tài liệu nào để nhận phân tích tức thì, những hiểu biết chủ chốt, trích xuất chủ đề, nhận diện thực thể và hơn thế nữa.",
      description: "Kéo và thả tài liệu hoặc nhấp để chọn",
